    ...
    >
      <Stack h={'full'} color={'white'} justifyContent={'center'} w={'full'}>
        ...
        >
          ...
          {/*Q4*/}
          <Box alignSelf={'flex-start'}>
            <HStack alignSelf={'flex-start'} alignItems={"flex-start"}>
              <VStack color={'white'} >
                <HStack>
                  <Flex
                    w={10}
                ...
                <Text alignSelf={"flex-start"}>Analiz ve Test Aşaması</Text>
                <UnorderedList>
                  <ListItem>Arayüz Tasarımının Araştırması</ListItem>
                  <ListItem>Wireframe Oluşturma</ListItem>
                  <ListItem>Arayüz Tasarımı</ListItem>
          ...
          <Box alignSelf={'flex-end'}>
            <HStack display={'flex'} justifyContent='center'>
              <HStack alignSelf={'flex-start'}>
                <Image alt={'q5'} src={'/Q5.png'} boxSize={12} alignSelf={"flex-start" } />
                <Flex
                  w={10}
                  h={10}
                  bg={'white'}
